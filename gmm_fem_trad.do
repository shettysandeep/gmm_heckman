*gmm code for gmm_fem_trad.dta (returning for associate degree)
/*keep tage sqage marry efnp faminc metro rfownkid firmsize rfoklt18 indcode lwr trad
gen constant=1
rename rfoklt18 child18
tab indcode, gen(ind)
gen bigfirm=firmsize==3
drop if lwr==.
log using gmm_fem_trad, replace
*/
...
mata matsave gmm_female_ad *  //saves all mata workspace as gmm_ad_male.mmat
mata matuse gmm_female_ad // retrieves for future work

end
save gmm_female_ad_1, replace
