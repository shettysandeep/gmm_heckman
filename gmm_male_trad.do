*! Earlier forgot to include dummy indicator in Z's. This includes. Code for step 1
* See imom2_with_result for code with results
* on gmm_bdeg_male.dta
*mata drop i_mom_bd_male()

use gmm_male_trad.dta,clear
...
seadmale=(sqrt(diagonal(cormat)))'
seadmale2=(sqrt(diagonal(cormat2)))'
resul=p\p3step\seadmale\seadmale2
*** End of Code
...
mata matsave gmm_ad_male * , replace  //saves all mata workspace as gmm_ad_male.mmat
*mata matuse gmm_ad_male // retrieves for future work

end

save gmm_male_trad_1, replace
